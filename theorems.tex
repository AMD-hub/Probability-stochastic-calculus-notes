...
% Suffix
%   r:              Allow Theorem/Definition/Lemma/Proposition to be referenced, e.g. thmr
%   p:              Add a short proof block for Theorem, Lemma, Corollary, Proposition, e.g. lemp
% to refer to a theorem/proposition.., use \ref{thm:label} \ref{prop:label}

% ======= Real examples : 
% \defn{name}{
%     This is a definition without a reference.
% }

% \defnr{name}{ref}{
%     This is a definition with a reference.
% }
...
\NewDocumentCommand{\thmpr}{m+m+m+m}{
    \begin{mytheorem}{#1}{#2}
        #3
    \end{mytheorem}
...
\NewDocumentCommand{\lempr}{m+m+m+m}{
    \begin{mylemma}{#1}{#2}
        #3
    \end{mylemma}
...
\NewDocumentCommand{\proppr}{+m+m+m}{
    \begin{myproposition}{}{#1}
        #2
    \end{myproposition}
